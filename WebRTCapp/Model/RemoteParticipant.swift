...
class RemoteParticipant {
    ...
    convenience init(id: String, mediaStream: RTCMediaStream, peerConnection: RTCPeerConnection, audioTrack: RTCAudioTrack, videoTrack: RTCVideoTrack, videoOff: Bool, micOff: Bool/*,
